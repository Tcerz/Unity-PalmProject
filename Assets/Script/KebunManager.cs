...
public class KebunManager : MonoBehaviour
{
    ...
    // Tambahkan referensi skrip gerbang yang ada di world
    ...
    IEnumerator SiklusAntreanTruk()
    {
        ...
        while (daftarAntreanPohon.Count >= 3)
        {
            ...
            if (scriptTruk != null)
            {
                // BARU: Hubungkan truk dengan gerbang yang ada di scene
                scriptTruk.skripGerbang = referensiGerbangWorld;
